...
/** Dialog builders shared by PrismSpace modules. */
@ParametersAreNonnullByDefault
@RequiresApi(LOLLIPOP) public final class Dialogs {
	...
	public static @CheckResult Builder buildAlert(final Activity activity, final @Nullable CharSequence title,
	...
	public static class Builder extends AlertDialog.Builder {
		...
		public @CheckResult Builder withOkButton(final @Nullable Runnable task) {
			setPositiveButton(android.R.string.ok, task == null ? null : (dialog, which) -> task.run());
			return this;
		}
		...
		Builder(final Context context) {
			super(context, getDayNightThemeForAlertDialog(context));
		}
	}
	...
	public static class FluentProgressDialog extends ProgressDialog {
		...
		public FluentProgressDialog onCancel(final OnCancelListener listener) {
