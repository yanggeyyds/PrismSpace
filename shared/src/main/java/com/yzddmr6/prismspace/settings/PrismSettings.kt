...
import com.yzddmr6.prismspace.PersistentService
import com.yzddmr6.prismspace.shared.R
import com.yzddmr6.prismspace.settings.AppSettings

class PrismSettings(private val context: Context) {
	...
	open inner class BooleanSetting(@StringRes prefKeyStringRes: Int, singleUser: Boolean = true)
		: PrismSetting<Boolean>(prefKeyStringRes, singleUser) {
	...
	open inner class PrismSetting<T>(override val prefKeyResId: Int, override val isSingleUser: Boolean) : AppSettings.AppSetting<T> {
