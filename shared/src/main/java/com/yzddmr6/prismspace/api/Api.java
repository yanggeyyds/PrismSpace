 ...
 * <p>API revisions:
 * <ul>
 * <li>v1.0 released in PrismSpace v2.0.
 * <li>v1.1 released in PrismSpace v2.5 (250).
 * <li>v2.0 released in PrismSpace v2.9 (29000).
 * <li>v2.1 released in PrismSpace v3.5.1 (35100).
 * </ul>
 *
...
public class Api {
	...
	interface v2 extends v1 {
		...
		String PERMISSION_FREEZE_PACKAGE = "com.yzddmr6.prismspace.permission.FREEZE_PACKAGE";
		String PERMISSION_LAUNCH_PACKAGE = "com.yzddmr6.prismspace.permission.LAUNCH_PACKAGE";
		String PERMISSION_SUSPEND_PACKAGE = "com.yzddmr6.prismspace.permission.SUSPEND_PACKAGE";
		 ...
		 * <p>Result: {@link Activity#RESULT_OK} for success, {@link Activity#RESULT_CANCELED} for failure or {@link latest#RESULT_UNVERIFIED_IDENTITY}
		 */
		@Since(2.1) @RequiresPermission(PERMISSION_SUSPEND_PACKAGE) String ACTION_SUSPEND = "com.yzddmr6.prismspace.action.SUSPEND";

		/**
		 * Unsuspend the app(s) specified by Intent data with "package" or "packages" (comma-separated) scheme. (requires Android N+)
		 * <p>Result: {@link Activity#RESULT_OK} for success, {@link Activity#RESULT_CANCELED} for failure or {@link latest#RESULT_UNVERIFIED_IDENTITY}
		 */
		@Since(2.1) @RequiresPermission(PERMISSION_SUSPEND_PACKAGE) String ACTION_UNSUSPEND = "com.yzddmr6.prismspace.action.UNSUSPEND";
	...
	interface v1 {
		@Since(1.0) String ACTION_FREEZE   = "com.yzddmr6.prismspace.action.FREEZE";
		@Since(1.1) String ACTION_UNFREEZE = "com.yzddmr6.prismspace.action.UNFREEZE";
		...
		@Since(1.1) String ACTION_LAUNCH   = "com.yzddmr6.prismspace.action.LAUNCH";
