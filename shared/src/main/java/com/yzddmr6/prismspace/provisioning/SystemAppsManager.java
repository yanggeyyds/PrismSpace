...
import com.yzddmr6.prismspace.engine.common.WellKnownPackages;
...
/**
 * Manage the critical system apps in PrismSpace
 *
...
@ProfileUser public class SystemAppsManager {
	...
	private static final Collection<String> sCriticalSystemPkgs = Arrays.asList(
			...
			"com.android.keychain",					// Required by credential and account flows on some ROMs
			...
			"com.android.vpndialogs",				// Required by VPN service app (e.g. ShadowSocks)
				...
				"com.google.android.documentsui",		// Google/MIUI DocumentsUI package name on some ROMs.
					Hacks.PrintManager_PRINT_SPOOLER_PACKAGE_NAME.get(),	// Print spooler
			...
			// MIUI-specific
				...
				"com.miui.packageinstaller",			// MIUI foreground package installer for APK handoff.
				"com.android.fileexplorer"				// MIUI file manager, user-facing APK source in normal install flow.
		);
	...
	private static final String TAG = "Prism.SysApps";
}
