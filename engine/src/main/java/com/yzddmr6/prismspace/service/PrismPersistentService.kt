package com.yzddmr6.prismspace.service
...
import com.yzddmr6.prismspace.util.UserPrefixedLog as Log
 ...
 */
@RequiresApi(O) class PrismPersistentService: DeviceAdminService() {
...
private const val TAG = "Prism.PS"
