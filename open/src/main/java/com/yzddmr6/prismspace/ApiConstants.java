...
@SuppressLint("InlinedApi") public class ApiConstants {
	 ...
	 */
	static final String TYPE_DELEGATION = "com.yzddmr6.prismspace.delegation";	// Name-spaced as requirement mentioned by RestrictionsManager.requestPermission()
	 ...
	 */
	public static final String REQUEST_KEY_USER_SERIAL_NUMBER = "com.yzddmr6.prismspace.request.user";
	...
	/* Custom delegations with PrismSpace namespace. */
	public static final String DELEGATION_APP_OPS = "-prismspace-delegation-app-ops";
}
