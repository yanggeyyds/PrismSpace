...
import com.yzddmr6.prismspace.open.BuildConfig
import com.yzddmr6.prismspace.open.R
...
class DelegatedScopeAuthorization : RestrictionsReceiver() {
    ...
    override fun onRequestPermission(context: Context, pkg: String?, requestType: String?, requestId: String?, request: PersistableBundle?) {
        ...
        NotificationIds.Authorization.post(context, requestId, Notification.Builder(context)
            ...
            .setColor(context.resources.getColor(com.yzddmr6.prismspace.shared.R.color.accent))
...
private const val TAG = "Prism.DSA"