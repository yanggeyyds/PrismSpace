package com.yzddmr6.prismspace.adb;
...
public class ProfileRestrictionsSync extends BroadcastReceiver {
	...
	@Override public void onReceive(final Context context, final Intent intent) {
		...
		if (Users.isParentProfile() || ! policies.isProfileOwner()) {	// This receiver is not needed in owner user or profile not managed by PrismSpace.
	...
	private static final String TAG = "Prism.PRS";
}
